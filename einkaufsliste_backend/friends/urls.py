...
from friends.views import FriendsAccepted, FriendsPending, FriendsRequested, FriendAdd, FriendDelete, FriendRequestAccept
...
urlpatterns = [
    ...
    path("accept_friend/<int:id>/", FriendRequestAccept.as_view(), name="friend_accept"),
    ]
